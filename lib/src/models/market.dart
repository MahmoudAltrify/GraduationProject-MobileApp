...
class Market {
  ...
  Market.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      deliveryFee = 0.0;
      adminCommission = 0.0;
      deliveryRange = 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999.9;
      address = '';
      description = '';
      phone = '';
      mobile = '';
      ...
      distance = 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999.9;
      users = [];
      print(e);
    }
  }
